...
struct Index
{
	...
	int32 compare(Region& arg1, Region& arg2)
	{
		return compare(arg1.data, arg1.size, arg2.data, arg2.size);
	}
	...
	{
		return (int32)(&(Type&)arg1 - &(Type&)arg2);
	}
	template<typename Type>
...
struct CastIndex : Index
{
	template<typename Type>
	uint32 hash(Type& key)
	{
		Cast& cast = (Cast&)key;
		return Index::hash(cast);
	}
	template<typename Type>
	int32 compare(Type& arg1, Type& arg2)
	{
		...
		return Index::compare(cast1, cast2);
	}
};
