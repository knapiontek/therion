...
core::String cs_clazz = cs("clazz");
core::String cs_extension = cs("extension");
core::String cs_notnil = cs("notnil");
core::String cs_punctuation = cs("!\"£$^&*()_+{}[]:@~;'#|\\<>?,./");
core::String cs_region_data = cs("***");
core::String cs_string = cs(" string: $ $");
core::String cs_region = cs(" region: ");
...
core::String cs_format = cs(" string: $$ $$$1 region: $2 bool: $3 int8: $4 int16: $A int32: $6 int64: $7 uint8: $8 uint16: $9 uint32: $5 uint64: $B float32: $C float64: $D float128: $E and the end$$");
core::String cs_hardcoded_output = cs(" string: $ $!\"£$^&*()_+{}[]:@~;'#|\\<>?,./ region: *** bool: false int8: -127 int16: -32767 int32: -2147483647 int64: -9223372036854775807 uint8: 127 uint16: 32767 uint32: 2147483647 uint64: 9223372036854775807 float32: 123456.78 float64: 1234567890.123456 float128: 1234567890.1234567 and the end$");
...
core::String cs_service_thread = cs("service-thread");
core::String cs_factory_target = cs("factory");
core::String cs_house_target = cs("house");
core::String cs_target_not_exist = cs("target: $1 does not exist");
