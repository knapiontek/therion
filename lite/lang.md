...
address-ref: address
my-address: address (town: 'my-town', street: 'my-street', house-no: 'my-house-no') { house-no <- house-no + 1 }

create-address: (town: unicode, street: unicode, house-no: int) -> address
{
    .town: town
    .street: street
    .house-no: house-no
