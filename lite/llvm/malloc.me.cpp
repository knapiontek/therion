...
Module* makeLLVMModule() {
    ...
    // primitive types
    IntegerType* int8Ty = IntegerType::get(mod->getContext(), 8);
    IntegerType* int16Ty = IntegerType::get(mod->getContext(), 16);
    IntegerType* int32Ty = IntegerType::get(mod->getContext(), 32);
    IntegerType* int64Ty = IntegerType::get(mod->getContext(), 64);
    ...
    FunctionType* funcMainTy = FunctionType::get(int32Ty, funcMainTy_args, false);
    ...
    FunctionType* funcMallocTy = FunctionType::get(pInt8Ty, funcMallocTy_args, false);
    PointerType* pFuncMallocTy = PointerType::get(funcMallocTy, 0);

    // Function Declarations
    Function* func_main = mod->getFunction("main");
    if (!func_main) {
        func_main = Function::Create(funcMainTy, GlobalValue::ExternalLinkage, "main", mod);
        func_main->setCallingConv(CallingConv::C);
    }
    Function* func_malloc = mod->getFunction("malloc");
    if (!func_malloc) {
        func_malloc = Function::Create(funcMallocTy, GlobalValue::ExternalLinkage, "malloc", mod); // (external, no body)
    ...
    // Function: main (func_main)
    {
        ...
        AllocaInst* allocaInt32 = new AllocaInst(int32Ty, "", bb_main);
