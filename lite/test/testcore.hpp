...
inline void test_pager()
{
	...
	for(core::uint32 i = 0; i < size; i++)
	{
		...
		*f = 0;
		...
		core::int32* seq = pager.acquire<core::int32>(100);
		seq[0] = 0;
		seq[99] = 99;

		seq = pager.acquire_nil<core::int32>(200);
		seq[0] = 0;
		seq[199] = 199;

		core::String* st = pager.acquire_class<core::String>();
		*st = cs_string;

		core::String* st_seq = pager.acquire_class<core::String>(2);
		st_seq[0] = cs_string;
		st_seq[1] = cs_string;
	}
}
